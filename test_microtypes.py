...
plt.subplot(211)
p3 = plt.contourf(bus_demands, car_demands, g3[0], vmin=0.0, vmax=8.0)  # , np.arange(0.08, 0.35, 0.02))
# p2 = plt.contour(bus_demands, car_demands, flows, np.arange(45, 200, 10), cmap='Greys')
cb3 = plt.colorbar(p3)
# cb2 = plt.colorbar(p2)
...
plt.subplot(212)
p3 = plt.contourf(bus_demands, car_demands, g3[1], vmin=0.0, vmax=8.0)  # , np.arange(0.08, 0.35, 0.02))
# p2 = plt.contour(bus_demands, car_demands, flows, np.arange(45, 200, 10), cmap='Greys')
cb3 = plt.colorbar(p3)
# cb2 = plt.colorbar(p2)
